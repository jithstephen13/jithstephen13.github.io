...
const Skills = () => {
 ...
 <ParallaxEfect baseVelocity={-2}>
        ...
        />
          ...
          width={100}
          height={100}
          className="rounded-full ml-16 mr-16 ml-10 mr-10 bg-white border-black  shadow-xl"
        />
          </div>
          ...
          width={100}
          height={100}
          className="rounded-full ml-16 mr-16 ml-10 mr-10 bg-white  shadow-xl"
        />
          </div>
          <div className="rounded-full ml-16 mr-16">
          <Image
        ...
        />
          ...
          width={100}
          height={100}
          className="rounded-full ml-16 mr-16 md:ml-10 mr-10  shadow-xl"
        />
          </div>
          <div className="rounded-full ml-16 mr-16">
          <Image
        ...
        />
          ...
          <div className="rounded-full   rounded-full ml-6 mr-16  mr-10 ">
      ...
      <div className="flex  m-auto overflow-hidden">
       ...
       />
         ...
         width={100}
         height={100}
         className="rounded-full ml-16 mr-16 ml-10 mr-10 bg-white  shadow-lg"
       />
         </div>
         <div className="rounded-full ml-16 mr-16">
         <Image
       ...
       />
         ...
         <div className="rounded-full ml-16 p-16   rounded-full ml-16 mr-16  mr-10">
        ...
        <div className="flex flex-col justify-center align-center   animate-slideUpCubiBezier animation-delay-2 md:space-x-12 p-6 mt-12  shadow-xl m-auto">
